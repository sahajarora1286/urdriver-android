package com.urdriver.sahajarora.myapplication.backend;
...
@Api(
        ...
        namespace = @ApiNamespace(
                ownerDomain = "backend.myapplication.sahajarora.urdriver.com",
                ownerName = "backend.myapplication.sahajarora.urdriver.com",
                packagePath = ""
        )
)
public class UserEndpoint {
     ...
     * Returns the {@link User} with the corresponding ID.
     *
     * @param email the email of the entity to be retrieved
    ...
    @ApiMethod(
            ...
            path = "user/login",
            httpMethod = ApiMethod.HttpMethod.GET)
    public User getUserByEmailPassword(@Named("email") String email, @Named("password") String password) throws NotFoundException {
       ...
       // System.out.println("---->> USER FOUND WITH EMAIL: " + user.getEmail());
        ...
        //if user found with email, then check password
        if (user != null) {
...
/*
        ...
        while (queryIterator.hasNext()){
            if (queryIterator.next().getEmail().equals(email) && queryIterator.next().getPassword().equals(password)){
                user = queryIterator.next();
                return user;
            }
        }
