...
public class NumberDriversActivity extends ActionBarActivity {
    ...
    public void openConfirmActivity(View view){
        String numDrivers = (String) spinnerNumberDrivers.getSelectedItem();
        String numHours = (String) spinnerNumberHours.getSelectedItem();
        startActivity(new Intent(NumberDriversActivity.this, PartyBookingSummaryActivity.class).putExtra("numDrivers", numDrivers)
        .putExtra("numHours", numHours));
    }
}
