...
import com.sahajarora.urdriver.endpointAsyncTasks.UserEndpointAsyncTask;
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty() || email.isEmpty() || password.isEmpty() || address.isEmpty() || postalCode.isEmpty() || phone.isEmpty() ||
                   etConfirmPassword.getText().length() == 0 ||
                        etCarModel.getText().length() == 0 || (!rbManual.isChecked() && !rbAutomatic.isChecked())) {
                    ...
                    String transmission = "";
                    if (rbManual.isChecked()) transmission = "Manual";
                    ...
                    user.setTransmission(transmission);
                    if (rbManual.isSelected()) user.setTransmission("Manual");
                    else if (rbAutomatic.isSelected()) user.setTransmission("Automatic");
                    else Toast.makeText(getApplicationContext(), "Please select transmission!", Toast.LENGTH_SHORT).show();

                    new UserEndpointAsyncTask(RegisterActivity.this).execute(new Pair<Activity, User>(RegisterActivity.this, user));
                }
            }
        });
    }
